...
Q.1.12. First Pass Test Kit 1 Lot Number [pos:: 11$$ id:: fp_lot_number1$$ expiry:: fp_lot_1_expiry$$ dispatch:: fp_lot_1_dispatch_id$$ condition:: evalCondition(0)$$ tt_onLoad:: __$("helpText" + tstCurrentPage).innerHTML = "First Pass " + __$("fp_item_name1").value.trim() + " Lot Number"]
Q.1.13. First Pass Test 1 Result [pos:: 12$$ id:: fp_test1_result$$ tt_onLoad:: saveConsumption(__$("fp_lot_1_dispatch_id").value); loadSerialTest(__$("fp_test1_result"), __$("fp_test1_duration"), __$("fp_item_name1").value.trim()); __$("helpText" + tstCurrentPage).innerHTML = "First Pass " + __$("fp_item_name1").value.trim() + " Result"$$ condition:: evalCondition(1)$$ tt_pageStyleClass:: NoControls NoKeyboard$$ optional:: true$$ tt_onUnload:: activateNavBtn()]
O.1.13.1. -
O.1.13.2. +
...
Q.1.16. First Pass Test Kit 2 Lot Number [pos:: 15$$ id:: fp_lot_number2$$ expiry:: fp_lot_2_expiry$$ dispatch:: fp_lot_2_dispatch_id$$ condition:: evalCondition(2)$$ tt_onLoad:: __$("helpText" + tstCurrentPage).innerHTML = "First Pass " + __$("fp_item_name2").value.trim() + " Lot Number"]
Q.1.17. First Pass Test 2 Result [pos:: 16$$ id:: fp_test2_result$$ condition:: evalCondition(3)$$ tt_onLoad:: saveConsumption(__$("fp_lot_2_dispatch_id").value); loadSerialTest(__$("fp_test2_result"), __$("fp_test2_duration"), __$("fp_item_name2").value.trim()); __$("helpText" + tstCurrentPage).innerHTML = "First Pass " + __$("fp_item_name2").value.trim() + " Result"$$ tt_pageStyleClass:: NoControls NoKeyboard$$ optional:: true$$ tt_onUnload:: activateNavBtn()]
O.1.17.1. -
O.1.17.2. +
...
Q.1.23. Immediate Repeat Test Kit 1 Lot Number [pos:: 22$$ id:: im_lot_number1$$ expiry:: im_lot_1_expiry$$ dispatch:: im_lot_1_dispatch_id$$ condition:: evalCondition(5)$$ tt_onLoad:: __$("helpText" + tstCurrentPage).innerHTML = "Immediate Repeat " + __$("im_item_name1").value.trim() + " Lot Number"]
Q.1.24. Immediate Repeat Test 1 Result [pos:: 23$$ id:: im_test1_result$$ tt_onLoad:: saveConsumption(__$("im_lot_1_dispatch_id").value)$$ condition:: false]
O.1.24.1. -
O.1.24.2. +
...
Q.1.27. Immediate Repeat Test Kit 2 Lot Number [pos:: 26$$ id:: im_lot_number2$$ expiry:: im_lot_2_expiry$$ dispatch:: im_lot_2_dispatch_id$$ condition:: evalCondition(5)$$ tt_onLoad:: __$("helpText" + tstCurrentPage).innerHTML = "Immediate Repeat " + __$("im_item_name2").value.trim() + " Lot Number"]
Q.1.28. Immediate Repeat Test 2 Result [pos:: 27$$ id:: im_test2_result$$ tt_onLoad:: saveConsumption(__$("im_lot_2_dispatch_id").value)$$ condition:: false]
O.1.28.1. -
O.1.28.2. +

Q.1.29. Immediate Repeat Test 1 & 2 Parallel Tests [pos:: 28$$ id:: fp_parallel$$ tt_onLoad:: saveConsumption(__$("fp_lot_1_dispatch_id").value); saveConsumption(__$("fp_lot_2_dispatch_id").value); loadPassParallelTests(__$("im_test1_result"), __$("im_test1_duration"), __$("im_test2_result"), __$("im_test2_duration"), __$("im_item_name1").value.trim(), __$("im_item_name2").value.trim()); __$("helpText" + tstCurrentPage).innerHTML = "Immediate Repeat " + __$("im_item_name1").value.trim() + " & " + __$("im_item_name2").value.trim() + " Parallel Tests"$$ condition:: evalCondition(5)$$ tt_pageStyleClass:: NoControls NoKeyboard$$ optional:: true$$ tt_onUnload:: activateNavBtn()]
