...
Q.1.17. Current Region [pos:: 17 $$ id :: region $$ tt_onUnload :: setAjaxUrl(0)$$ tt_requireNextClick :: false $$ condition :: ((__$("patient").value.trim() == "AUTO") && __$("selected_advanced_patient").value.trim().length <= 0 && __$('detail_type').value.trim().toLowerCase() == 'current residence' || __$('detail_type').value.trim().toLowerCase() == 'both') || evalDemographicCondotion(0)]
O.1.17.1. Central Region
O.1.17.2. Northern Region
O.1.17.3. Southern Region

Q.1.18. Current District [pos :: 18 $$ id :: district $$ tt_onUnload :: setAjaxUrl(1) $$ tt_requireNextClick :: false $$ condition :: ((__$("patient").value.trim().length <= 0 || __$("patient").value.trim() == "AUTO") && __$("selected_advanced_patient").value.trim().length <= 0 && __$('detail_type').value.trim().toLowerCase() == 'current residence' || __$('detail_type').value.trim().toLowerCase() == 'both') || evalDemographicCondotion(0)]

Q.1.20. Current T/A [pos:: 19 $$ id:: ta $$ tt_onUnload:: setAjaxUrl(2) $$ tt_requireNextClick :: false $$ condition :: ((__$("patient").value.trim().length <= 0 || __$("patient").value.trim() == "AUTO") && __$("selected_advanced_patient").value.trim().length <= 0 && __$('detail_type').value.trim().toLowerCase() == 'current residence' || __$('detail_type').value.trim().toLowerCase() == 'both') || evalDemographicCondotion(0)]

Q.1.21. Current Village [pos:: 20 $$ id :: village $$ tt_requireNextClick :: false $$ condition :: __$('ta').value.trim().length > 0 && evalDemographicCondotion(0)]

Q.1.22. Current Village Specify [pos :: 21 $$ id :: village_specify $$ tt_requireNextClick :: true $$ condition :: __$('village').value == 'Other']

Q.1.23. Closest Landmark [pos :: 22 $$ id :: closest_landmark $$ condition :: ((__$("patient").value.trim().length <= 0 || __$("patient").value.trim() == "AUTO") && __$("selected_advanced_patient").value.trim().length <= 0 && __$('detail_type').value.trim().toLowerCase() == 'current residence' || __$('detail_type').value.trim().toLowerCase() == 'both') || evalDemographicCondotion(0)]
