...
Q.1.32. Region of Origin [pos:: 8 $$ id :: region_of_origin $$ tt_onUnload :: setAjaxUrl(-1) $$ tt_requireNextClick :: false $$ condition :: __$("capture_details").value.trim().toLowerCase() == "yes" &&  (window.parent.dashboard.data.data.addresses && window.parent.dashboard.data.data.addresses.length > 0 && window.parent.dashboard.data.data.addresses["Home District"] ? window.parent.dashboard.data.data.addresses["Home District"] : "").length < 2]
O.1.32.1. Central Region
O.1.32.2. Northern Region
O.1.32.3. Southern Region

Q.1.8. Home district [pos :: 9 $$ id :: home_district $$ ajaxURL :: <<window.parent.patient.settings.ddePath + window.parent.patient.settings.districtQueryPath + "?region=&district=">> $$ condition :: __$("capture_details").value.trim().toLowerCase() == "yes" && (window.parent.dashboard.data.data.addresses && window.parent.dashboard.data.data.addresses.length > 0 && window.parent.dashboard.data.data.addresses["Home District"] ? window.parent.dashboard.data.data.addresses["Home District"] : "").length < 2 ]

Q.1.9. Year of Birth [pos :: 10 $$ id :: birthyear $$ disabled :: true $$ field_type :: number $$ tt_pageStyleClass :: Numeric NumbersWithUnknown $$ tt_onUnLoad :: validateMaxMinYear() $$ condition :: __$("capture_details").value.trim().toLowerCase() == "no" || (window.parent.dashboard.data.data.birthdate && window.parent.dashboard.data.data.birthdate.trim().length > 0 ? window.parent.dashboard.data.data.birthdate.trim() : "").length < 2]

Q.1.10. Age Estimate [pos :: 11 $$ id :: age_estimate $$ field_type :: number $$ condition :: __$('birthyear').value.trim().toLowerCase() == "unknown" && (window.parent.dashboard.data.data.birthdate && window.parent.dashboard.data.data.birthdate.trim().length > 0 ? window.parent.dashboard.data.data.birthdate.trim() : "").length < 2 $$  tt_pageStyleClass::Numeric NumbersOnly $$ tt_onUnLoad :: setEstimatedAgeValue() $$ absoluteMax :: 150 $$ min :: 1 max :: 100]

Q.1.11. Month of Birth [pos :: 12 $$ id :: birthmonth $$ disabled :: true $$ condition ::__$('birthyear').value.trim().toLowerCase() != "unknown" && (window.parent.dashboard.data.data.birthdate && window.parent.dashboard.data.data.birthdate.trim().length > 0 ? window.parent.dashboard.data.data.birthdate.trim() : "").length < 2 $$ tt_onUnLoad :: validateAndProcessMonth() $$ allowFreeText :: false $$ tt_pageStyleClass :: LongSelectList NoKeyboard]
O.1.11.1. January
O.1.11.2. February
O.1.11.3. March
O.1.11.4. April
...
Q.1.17. Current Region [pos:: 17 $$ id :: region $$ tt_onUnload :: setAjaxUrl(0)$$ tt_requireNextClick :: false $$ condition :: ((__$("patient").value.trim().length <= 0 || __$("patient").value.trim() == "AUTO") && __$("selected_advanced_patient").value.trim().length <= 0 && __$('detail_type').value.trim().toLowerCase() == 'current residence' || __$('detail_type').value.trim().toLowerCase() == 'both') && (!window.parent.dashboard.data["data"]["addresses"] || (window.parent.dashboard.data["data"]["addresses"] && !window.parent.dashboard.data["data"]["addresses"]["Current District"]))]
O.1.17.1. Central Region
O.1.17.2. Northern Region
O.1.17.3. Southern Region

Q.1.18. Current District [pos :: 18 $$ id :: district $$ tt_onUnload :: setAjaxUrl(1) $$ tt_requireNextClick :: false $$ condition :: ((__$("patient").value.trim().length <= 0 || __$("patient").value.trim() == "AUTO") && __$("selected_advanced_patient").value.trim().length <= 0 && __$('detail_type').value.trim().toLowerCase() == 'current residence' || __$('detail_type').value.trim().toLowerCase() == 'both') && (!window.parent.dashboard.data["data"]["addresses"] || (window.parent.dashboard.data["data"]["addresses"] && !window.parent.dashboard.data["data"]["addresses"]["Current District"]))]

Q.1.20. Current T/A [pos:: 19 $$ id:: ta $$ tt_onUnload:: setAjaxUrl(2) $$ tt_requireNextClick :: false $$ condition :: ((__$("patient").value.trim().length <= 0 || __$("patient").value.trim() == "AUTO") && __$("selected_advanced_patient").value.trim().length <= 0 && __$('detail_type').value.trim().toLowerCase() == 'current residence' || __$('detail_type').value.trim().toLowerCase() == 'both') && (!window.parent.dashboard.data["data"]["addresses"] || (window.parent.dashboard.data["data"]["addresses"] && !window.parent.dashboard.data["data"]["addresses"]["Current District"]))]
...
Q.1.23. Closest Landmark [pos :: 22 $$ id :: closest_landmark $$ condition :: ((__$("patient").value.trim().length <= 0 || __$("patient").value.trim() == "AUTO") && __$("selected_advanced_patient").value.trim().length <= 0 && __$('detail_type').value.trim().toLowerCase() == 'current residence' || __$('detail_type').value.trim().toLowerCase() == 'both') && (!window.parent.dashboard.data["data"]["addresses"] || (window.parent.dashboard.data["data"]["addresses"] && !window.parent.dashboard.data["data"]["addresses"]["Current District"]))]
