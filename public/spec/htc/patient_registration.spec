...
O.1.6.2.1.1. Yes
O.1.6.2.1.2. No
Q.1.7. Consept given to capture name and contact details? [pos:: 7$$ id:: capture_details]
O.1.7.1. Yes
O.1.7.2. No
...
Q.1.10. Contact Detail Type [pos:: 10 $$ condition:: __$('capture_details').value.trim().toLowerCase() == 'yes';$$tt_onUnload:: setPhoneNumberValidation('phone_number')]
