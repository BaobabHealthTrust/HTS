...
Q.1.4. Last HIV Test [pos :: 6 $$ id :: last_hiv_test $$ tt_requirenextclick :: false $$ tt_onUnload :: updatePartner("PRE TEST COUNSELLING", "Partner HIV Status", __$("touchscreenInput" + tstCurrentPage).value); updatePartnerObs();  $$ tt_pagestyleclass :: longSelectList]
...
Q.1.5. Estimate [pos :: 7 $$ id :: estimate $$ condition :: false]

Q.1.6. Time Since Last Test [pos :: 8 $$ id :: time_since_last_test $$ type :: hidden]

Q.1.7. Duration in Days [pos :: 9 $$ id :: duration_in_days $$ type :: hidden]

Q.1.8. Time Since Last Test Date [pos :: 10 $$ id :: time_since_last_test_date $$ type :: hidden $$ value :: 1900-01-01 ]

Q.1.9. Duration Control [pos :: 11 $$ id :: duration_ago $$ tt_onLoad :: showTimeSinceLastDate() $$ tt_pageStyleClass :: NoControls NoKeyboard $$ condition :: __$("last_hiv_test").value.trim().length > 0 && ['Never Tested', 'Last Exposed Infant'].indexOf(__$('last_hiv_test').value) < 0 $$ optional :: true $$ helpText :: Time Since Last Test Date]
...
Q.1.12. Partner HIV Status [pos :: 14 $$ id :: phs $$ value :: No Partner $$ condition :: false]

Q.1.13. Client Risk Category [pos :: 15 $$ id :: risk_category $$ tt_requirenextclick :: false $$ tt_pagestyleclass :: longSelectList]
O.1.13.1. Low Risk
O.1.13.2. On-going Risk
O.1.13.3. High Risk Event in Last 3 months
O.1.13.4. Risk assessment Not Done

Q.1.14. Event in the last 72 hrs? [pos :: 16 $$ id :: last_72 $$ condition :: __$("risk_category").value == "High Risk Event in Last 3 months" $$ tt_requirenextclick :: false]
O.1.14.1. Yes
O.1.14.2. No


Q.1.15. HTS Visit Summary [pos :: 17 $$ tt_onLoad :: setTimeSinceLastDate(); showHTSVisitSummary(); updateTimeSinceLastTest(); $$ optional :: true $$ tt_pageStyleClass :: NoControls NoKeyboard]
