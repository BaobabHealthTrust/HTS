...
Q.1.6. Time Since Last Test Date [pos:: 4$$ concept:: Time Since Last Test$$ id:: time_since_last_test_date$$ field_type:: birthdate$$ estimate_field:: estimate$$estimate_label::Time Estimate$$ condition:: __$('last_hiv_test').value != 'Never Tested']
