...
Q.1.16. First Pass Test Kit 2 Lot Number [pos :: 15 $$ id :: fp_lot_number2 $$ expiry :: fp_lot_2_expiry $$ dispatch :: fp_lot_2_dispatch_id $$ condition :: !evalCondition(-2) && evalCondition(2) $$ tt_onLoad :: if(__$("fp_lot_number2").getAttribute("consumption_id")){reverseConsumption(__$("fp_lot_number2").getAttribute("consumption_id"),"fp", "2")} $$ tt_onUnLoad :: validateExpiryDate(__$('touchscreenInput' + tstCurrentPage).value, "fp_lot_2_dispatch_id"); firstRun = true ]
