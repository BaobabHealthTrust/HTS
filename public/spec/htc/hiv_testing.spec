...
Q.1.13. First Pass Test 1 Result [pos:: 12$$ id:: fp_test1_result$$ tt_onLoad:: loadSerialTest(__$("fp_test1_result"), __$("fp_test1_duration"), window.parent.dashboard.data.kits['First Test'])$$ condition:: evalCondition(1)$$ tt_pageStyleClass:: NoControls NoKeyboard$$ optional:: true$$ tt_onUnload:: activateNavBtn()]
O.1.13.1. -
O.1.13.2. +
...
Q.1.17. First Pass Test 2 Result [pos:: 16$$ id:: fp_test2_result$$ condition:: evalCondition(3)$$ tt_onLoad:: loadSerialTest(__$("fp_test2_result"), __$("fp_test2_duration"),window.parent.dashboard.data.kits['Second Test']) $$ tt_pageStyleClass:: NoControls NoKeyboard$$ optional:: true$$ tt_onUnload:: activateNavBtn()]
O.1.17.1. -
O.1.17.2. +
...
Q.1.24. Immediate Repeat Test 1 Result [pos:: 23$$ id:: im_test1_result$$ condition:: false]
O.1.24.1. -
O.1.24.2. +
...
Q.1.28. Immediate Repeat Test 2 Result [pos:: 27$$ id:: im_test2_result$$ condition:: false]
O.1.28.1. -
O.1.28.2. +
