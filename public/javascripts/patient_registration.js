...
var patient = ({
    ...
    loadNames: function () {
        ...
        editPatient.onmousedown = function () {
            ...
            patient.buildEditPage(patient.$("first_name").value.trim(), patient.$("last_name").value.trim(),
                patient.$("gender").value.trim());
    ...
    buildEditPage: function(data) {

        // TODO: Need to add logic for updating patient here

        alert("TODO: Edit patient data");
            ...
            if (patient.settings.demographics[fields[i]] || ["Current Region", "Region of Origin",
                ...
                switch (fields[i]) {
                    ...
                    case "First Name":
                        ...
                        input.setAttribute("tt_onLoad", "patient.$('nextButton').style.display = 'block';");
